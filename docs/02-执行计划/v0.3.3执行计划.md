...
|------|------|
| 文档版本 | v0.3.3 |
| 关联需求 | [需求规格.md](../00-总览/需求规格.md) v0.3.3 |
| 基础搭建 | [实现步骤计划.md](../00-总览/实现步骤计划.md)（v0.2 从零搭建，历史参考） |
| 预估工期 | 15～18 人天（1 人全栈） |
...
| **FR 可追溯** | 每项验证关联 [需求规格](../00-总览/需求规格.md) 中的 FR/NFR ID |
...
3. 新增权限 Catalog 常量模块（与 [需求规格 §2.5](../00-总览/需求规格.md) 完全一致）
...
**目标：** [需求规格 §6.3](../00-总览/需求规格.md) MVP 清单 **全部勾选**。
