...
> 配套可视化版：`docs/01-PRD/PRD-智营获客-整合v1.3.html`
> 来源：docs/00-总览/需求规格.md（SRS v0.8.5）、各版本执行计划、人格库手册、现有模块 PRD（*-prd）
...
---
*修订记录：v1.3 整合 PRD 重建，覆盖 v0.3.3→v1.3 全链路，对齐 Alembic 085 与 v1.3 七项硬决议（2026-07-17）。原稿为 docs/00-总览/需求规格.md 及分散模块级 PRD。*
