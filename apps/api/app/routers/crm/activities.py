...
from app.services.crm.activity_service import create_activity, delete_activity, list_activities
...
def get_activities(
    ...
    items = list_activities(db, ctx, lead_id=lead_id, customer_id=customer_id)
