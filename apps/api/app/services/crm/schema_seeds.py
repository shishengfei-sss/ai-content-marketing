...
LEAD_FIELDS: list[dict[str, Any]] = [
    ...
    # 覆盖 COMMON_FIELDS.territory_id：线索销售区域必填
    {
        "field_key": "territory_id",
        "label": "销售区域",
        "field_type": "territory_ref",
    ...
    {
        "field_key": "source_detail",
        "label": "来源说明",
        "field_type": "text",
        "storage": "db",
        "placeholder": "如：转介绍人姓名、活动场次",
        "sort_order": 205,
    },
    {
        ...
        "field_type": "text",
        "storage": "db",
        "placeholder": "utm_source，如 weixin / baidu",
        "sort_order": 211,
    },
    {
        "field_key": "utm_medium",
        "label": "投放媒介",
        "field_type": "text",
        "storage": "db",
        "placeholder": "utm_medium，如 cpc / social",
        "sort_order": 212,
    },
    {
        "field_key": "utm_campaign",
        "label": "投放活动",
        "field_type": "text",
        "storage": "db",
...
CUSTOMER_FIELDS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "label": "获客来源",
        "field_type": "select",
        "options": list(CRM_SOURCE_OPTIONS),
        "storage": "db",
        "show_in_list_default": True,
        "sort_order": 45,
    },
    ...
    {
        "field_key": "converted_lead_score",
        "label": "转化时线索评分",
        "field_type": "number",
        "storage": "db",
        "is_system": True,
...
CAMPAIGN_FIELDS: list[dict[str, Any]] = [
    ...
    {"field_key": "end_at", "label": "结束日期", "field_type": "datetime", "storage": "db", "sort_order": 40},
    {
        ...
        "label": "活动类型",
        "field_type": "select",
        "options": ["content", "online", "offline", "exhibition", "training", "other"],
        "show_in_list_default": True,
        "storage": "db",
        "sort_order": 45,
    },
    ...
    {"field_key": "description", "label": "策划说明", "field_type": "textarea", "storage": "db", "sort_order": 65},
    {
        "field_key": "budget",
        "label": "预算",
        "field_type": "currency",
...
PAYMENT_FIELDS: list[dict[str, Any]] = [
    ...
    {
        "field_key": "order_overdue_amount",
        "label": "订单逾期",
        "field_type": "currency",
        "is_system": True,
        "show_in_list_default": True,
