"""Agent sessions and messages (v0.4)
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("industry_code", sa.String(50), nullable=False, server_default="finance"),
...
def downgrade() -> None:
    ...
    op.drop_index("ix_agent_sessions_tenant_user", table_name="agent_sessions")
